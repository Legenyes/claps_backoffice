...
/**
 * @ApiResource()
 * @ORM\Entity(repositoryClass="App\Repository\ClothesTypeRepository")
 */
class ClothesType
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\ClothesTypeType", inversedBy="clothesTypes")
     */
    private $type;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\ClothesTypeZone", inversedBy="clothesTypes")
     */
    private $zone;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\ClothesPiece", mappedBy="clotheType")
     */
