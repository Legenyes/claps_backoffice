...
/**
 * @ApiResource()
 * @ORM\Entity(repositoryClass="App\Repository\ClothesTypeTypeRepository")
 */
class ClothesTypeType
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\ClothesType", mappedBy="type")
     */
