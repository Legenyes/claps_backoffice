 ...
 */
final class Version20181109001621 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE club (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, head_office_address_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, vat_number VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_B8EE3872742C3FD4 FOREIGN KEY (head_office_address_id) REFERENCES address (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('DROP INDEX IDX_DF4AB9D73256915B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__club_year AS SELECT id, relation_id, date_start, date_stop FROM club_year');
        ...
        $this->addSql('INSERT INTO club_year (id, club_id, date_start, date_stop) SELECT id, relation_id, date_start, date_stop FROM __temp__club_year');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE club_year');
        $this->addSql('CREATE TABLE club_year (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date_start DATE NOT NULL, date_stop DATE NOT NULL, relation_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO club_year (id, relation_id, date_start, date_stop) SELECT id, club_id, date_start, date_stop FROM __temp__club_year');
        $this->addSql('DROP TABLE __temp__club_year');
