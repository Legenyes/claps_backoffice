 ...
 */
final class Version20190309150832 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE clothes_color ADD COLUMN code VARCHAR(10) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__clothes_color AS SELECT id, name FROM clothes_color');
        ...
        $this->addSql('INSERT INTO clothes_color (id, name) SELECT id, name FROM __temp__clothes_color');
        $this->addSql('DROP TABLE __temp__clothes_color');
        $this->addSql('DROP INDEX IDX_709B974E4EC001D1');
        $this->addSql('DROP INDEX IDX_709B974EA1915070');
        $this->addSql('DROP INDEX IDX_709B974E5E00894B');
        $this->addSql('DROP INDEX IDX_709B974E8A1E26D');
