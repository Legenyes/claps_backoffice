 ...
 */
final class Version20190921155154 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE playlist (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL)');
        $this->addSql('CREATE TABLE playlist_video (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, playlist_id INTEGER NOT NULL, video_id INTEGER NOT NULL, position INTEGER NOT NULL)');
        ...
        $this->addSql('CREATE TABLE video (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, record_date DATETIME DEFAULT NULL, country VARCHAR(5) DEFAULT NULL)');
        $this->addSql('CREATE TABLE video_section (video_id INTEGER NOT NULL, section_id INTEGER NOT NULL, PRIMARY KEY(video_id, section_id))');
        $this->addSql('CREATE INDEX IDX_C89E934229C1004E ON video_section (video_id)');
        $this->addSql('CREATE INDEX IDX_C89E9342D823E37A ON video_section (section_id)');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, date DATETIME DEFAULT NULL, is_highlight BOOLEAN NOT NULL)');
