 ...
 */
final class Version20190619162118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__clothes_piece AS SELECT id, season_id, clothe_type_id, clothe_texture_id, clothe_opportunity_id, name, code, description, country, area, city, personal, gender FROM clothes_piece');
