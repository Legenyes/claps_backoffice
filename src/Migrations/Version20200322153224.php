 ...
 */
final class Version20200322153224 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_DFDBC36F29C1004E');
        $this->addSql('DROP INDEX IDX_DFDBC36F6BBD148');
        $this->addSql('CREATE TEMPORARY TABLE __temp__playlist_video AS SELECT id, playlist_id, video_id, position FROM playlist_video');
        $this->addSql('DROP TABLE playlist_video');
        $this->addSql('CREATE TABLE playlist_video (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, playlist_id INTEGER NOT NULL, video_id INTEGER NOT NULL, position INTEGER NOT NULL, CONSTRAINT FK_DFDBC36F6BBD148 FOREIGN KEY (playlist_id) REFERENCES playlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DFDBC36F29C1004E FOREIGN KEY (video_id) REFERENCES video (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO playlist_video (id, playlist_id, video_id, position) SELECT id, playlist_id, video_id, position FROM __temp__playlist_video');
        $this->addSql('DROP TABLE __temp__playlist_video');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__video AS SELECT id, name, url, record_date, country FROM video');
        $this->addSql('DROP TABLE video');
        $this->addSql('CREATE TABLE video (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, event_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, url VARCHAR(255) NOT NULL COLLATE BINARY, record_date DATETIME DEFAULT NULL, country VARCHAR(5) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_7CC7DA2C71F7E88B FOREIGN KEY (event_id) REFERENCES event (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO video (id, name, url, record_date, country) SELECT id, name, url, record_date, country FROM __temp__video');
        $this->addSql('DROP TABLE __temp__video');
        $this->addSql('CREATE INDEX IDX_7CC7DA2C71F7E88B ON video (event_id)');
        $this->addSql('DROP INDEX IDX_C89E9342D823E37A');
        $this->addSql('DROP INDEX IDX_C89E934229C1004E');
        $this->addSql('CREATE TEMPORARY TABLE __temp__video_section AS SELECT video_id, section_id FROM video_section');
        $this->addSql('DROP TABLE video_section');
        $this->addSql('CREATE TABLE video_section (video_id INTEGER NOT NULL, section_id INTEGER NOT NULL, PRIMARY KEY(video_id, section_id), CONSTRAINT FK_C89E934229C1004E FOREIGN KEY (video_id) REFERENCES video (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C89E9342D823E37A FOREIGN KEY (section_id) REFERENCES section (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO video_section (video_id, section_id) SELECT video_id, section_id FROM __temp__video_section');
        $this->addSql('DROP TABLE __temp__video_section');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_DFDBC36F6BBD148 ON playlist_video (playlist_id)');
        $this->addSql('CREATE INDEX IDX_DFDBC36F29C1004E ON playlist_video (video_id)');
        $this->addSql('DROP INDEX IDX_7CC7DA2C71F7E88B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__video AS SELECT id, name, url, record_date, country FROM video');
        $this->addSql('DROP TABLE video');
