 ...
 */
final class Version20190323111059 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE clothes_piece (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, season_id INTEGER DEFAULT NULL, clothe_type_id INTEGER DEFAULT NULL, clothe_texture_id INTEGER DEFAULT NULL, clothe_opportunity_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, code VARCHAR(255) NOT NULL COLLATE BINARY, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, country VARCHAR(255) DEFAULT NULL COLLATE BINARY, area VARCHAR(255) DEFAULT NULL COLLATE BINARY, city VARCHAR(255) DEFAULT NULL COLLATE BINARY, personal BOOLEAN DEFAULT NULL, gender CLOB DEFAULT NULL --(DC2Type:array)
        , CONSTRAINT FK_709B974E4EC001D1 FOREIGN KEY (season_id) REFERENCES clothes_season (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_709B974EA1915070 FOREIGN KEY (clothe_type_id) REFERENCES clothes_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_709B974E5E00894B FOREIGN KEY (clothe_texture_id) REFERENCES clothes_texture (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_709B974E8A1E26D FOREIGN KEY (clothe_opportunity_id) REFERENCES clothes_opportunity (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
